...
do
{
    ...
    // switch-case construct for menu options
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            do // Get pet physical description
            {
            ...
            do // Get pet personality description
            {
            ...
            // Stores the pet information in the ourAnimals array
        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    // Prompts user to input age - value must be a number
                    ...
                    // Prompts user to input physical description if empty.
