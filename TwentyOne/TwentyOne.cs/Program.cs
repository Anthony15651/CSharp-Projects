    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (answer == "yes" || answer == "yeah" || answer == "y" || answer == "ya" || answer == "yup")
            {
                ...
                using (StreamWriter file = new StreamWriter(@"C:\Users\antho\OneDrive\Desktop\test.txt", true))
                {
                ...
                while (player.isActivelyPlaying && player.Balance > 0)
                {
                    ...
                    {
                        Console.WriteLine("An error ocured. Please contact your system administrator.");
                        UpdateDbWithException(ex);
                        Console.ReadLine();
                        return;
                    }
